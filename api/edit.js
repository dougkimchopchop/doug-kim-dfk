// POST /api/edit  { id, text, type }  -> updates that block's rich_text in place
// `type` must be the Notion block type ('bulleted_list_item' or 'to_do'), as
// returned per-item by /api/list. Falls back to 'bulleted_list_item' if omitted.
